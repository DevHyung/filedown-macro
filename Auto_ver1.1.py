...
def samsung():
    try:
        try:
            app = Application().start("./nos_setup.exe")
        except:
            pass
        time.sleep(2)
        ...
        driver.get('https://www.samsungcard.com/merchant/sales/UHPMRP0101M0.jsp')
        time.sleep(3)
        try:
            Alert(driver).accept()
        except:
        ...
        driver.find_element_by_xpath('//*[@id="cusomtSelectbox_37_button"]/a').click()
        time.sleep(2)
        driver.find_element_by_xpath('//*[@id="cusomtSelectbox_37_menu"]/div[1]/ul/li[3]/a').click()
        time.sleep(2)
